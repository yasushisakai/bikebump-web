        ...
        <div className="map">
            ...
            <Map center={position} zoom={props.zoom} style={{height:"100vh"}}>
                <TileLayer
                    ...
                    url='https://api.mapbox.com/styles/v1/yasushisakai/ciu8srn4u002v2jrxc81ty7as/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoieWFzdXNoaXNha2FpIiwiYSI6ImNpdThwajN1ZTAwNjUzM28weHRuMnJ4a2kifQ.ooHi0pGR-SdDraWzTRCoVA'
                />
                {fences}
            </Map>
        </div>
